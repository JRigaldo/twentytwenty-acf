...
// Permalink for acf Simple Post Type Permalinks
...
register_post_type( 'event',
    array(
        ...
        "sptp_permalink_structure" => "event/%post_id%"
    )
);
...
if( function_exists('acf_register_block_type') ){
	...
	add_action('acf/init', 'my_acf_blocks_init_pack');
	add_action('acf/init', 'my_acf_blocks_intersection');
	add_action('acf/init', 'my_acf_blocks_list_block');
	add_action('acf/init', 'my_acf_blocks_list_icon');
	add_action('acf/init', 'my_acf_blocks_split_separator');
}
...
function my_acf_blocks_init_pack(){
		// Register a testimonial block.
        acf_register_block_type(array(
            'name'              => 'Pack',
            'title'             => __('Pack'),
            'description'       => __('A custom pack block.'),
            'render_template'   => 'template-parts/blocks/pack/pack.php',
			'category'          => 'formatting',
			'icon' 				=> 'yes',
			'align'				=> 'full',
            'keyword'			=> array('pack', 'description')
        ));
}

function my_acf_blocks_intersection(){
		// Register a testimonial block.
        acf_register_block_type(array(
            'name'              => 'Intersection',
            'title'             => __('Intersection'),
            'description'       => __('A custom intersection block.'),
            'render_template'   => 'template-parts/blocks/intersection/intersection.php',
			'category'          => 'formatting',
			'icon' 				=> 'yes',
			'align'				=> 'full',
            'keyword'			=> array('intersection', 'aside')
        ));
}

function my_acf_blocks_list_block(){
	// Register a testimonial block.
        acf_register_block_type(array(
            'name'              => 'List-block',
            'title'             => __('List-block'),
            'description'       => __('A custom list-block.'),
            'render_template'   => 'template-parts/blocks/list-block/list-block.php',
			'category'          => 'formatting',
			'icon' 				=> 'yes',
			'align'				=> 'full',
            'keyword'			=> array('list-block')
        ));
}

function my_acf_blocks_list_icon(){
	// Register a testimonial block.
        acf_register_block_type(array(
            'name'              => 'List-icon',
            'title'             => __('List-icon'),
            'description'       => __('A custom list-icon block.'),
            'render_template'   => 'template-parts/blocks/list-icon/list-icon.php',
			'category'          => 'formatting',
			'icon' 				=> 'yes',
			'align'				=> 'center',
            'keyword'			=> array('list', 'list-icon'),
        ));
}

function my_acf_blocks_split_separator(){
	// Register a testimonial block.
        acf_register_block_type(array(
            'name'              => 'Avatar',
            'title'             => __('Avatar'),
            'description'       => __('A custom avatar block.'),
            'render_template'   => 'template-parts/blocks/avatar/avatar.php',
			'category'          => 'formatting',
			'icon' 				=> 'yes',
			'align'				=> 'center',
            'keyword'			=> array('list', 'split-separator'),
        ));
}
...
/**
 * Register and Enqueue Scripts for slick slider
 */
function themeprefix_slick_enqueue_scripts_styles() {
	...
	wp_enqueue_script( 'block-slider', get_template_directory_uri() . '/assets/js/slider.js', array(), '1.0.0', true );
	...
	wp_enqueue_style( 'block-slider', get_template_directory_uri() . '/assets/css/slider.min.css', array(), '1.0.0' );
	wp_enqueue_style( 'header-slider', get_template_directory_uri() . '/assets/css/slider-header.css', array(), '1.0.0' );
